...
dataset_list = ['ASSISTments2009', 'ASSISTments2015', 'STATICS']
...
# SAINT
model_args.add_argument('--num_enc_layers', type=int, default=3)
model_args.add_argument('--num_dec_layers', type=int, default=3)

# MxKT
mixer_list = ['MLP', 'ResMLP', 'gMLP']
model_args.add_argument('--expand', type=int, default=4)
model_args.add_argument('--mixer_type', type=str, default='MLP',
                        choices=mixer_list)
model_args.add_argument('--layer_scale', type=float, default=1.0)
